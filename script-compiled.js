	...
	$('form').submit(function (event) {
		...
		$.ajax({
			...
			$.each(results, function (index, val) {
				...
				// Create Elements
				var copyButton = $('<button>').addClass('btn').addClass('btn-primary').addClass('copy-action').text('Copy!');

				var $citationBlock = $('<div>').addClass('citation-container').append($('<div>').attr('id', 'citation').html(lastName + firstName + middleName + pubDate + title + publication.italics() + webUrl)).append(copyButton);
